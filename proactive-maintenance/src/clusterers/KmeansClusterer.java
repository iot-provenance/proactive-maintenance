...
public class KmeansClusterer extends Clusterer {
	...
	private BICO clusTree;	
		
	public KmeansClusterer(String evaluationName, int k) {		
	
		super(evaluationName);
		
		BICO b= new BICO();
		b.numDimensionsOption = new IntOption("Dimensions", 'd',
						"Number of the dimensions of the input points.", 24, 1,
						Integer.MAX_VALUE);
		b.numClustersOption = new IntOption("Cluster", 'k',
				"Number of desired centers.", k, 1, Integer.MAX_VALUE);
		this.clusTree =b;
		
		this.clusTree.resetLearning();		
