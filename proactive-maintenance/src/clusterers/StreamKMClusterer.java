...
public class StreamKMClusterer extends Clusterer{
	
	private StreamKM denStream;	
	
	public StreamKMClusterer(String evaluationName, int k) {	
		
		super(evaluationName);
		this.denStream = new StreamKM();
		this.denStream.numClustersOption = new IntOption(
				"numClusters", 'k',
				"Number of clusters to compute.", k);
		this.denStream.resetLearningImpl();	
