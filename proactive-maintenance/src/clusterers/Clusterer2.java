...
public abstract class Clusterer2 {
	...
	public int Threshold=350;
		
	public Clusterer2(String evaluationName) {
	...
	public Clusterer2(String evaluationName , int streamCount , boolean multi) {	
		...
		for(int i=0;i<this.dataPoints.size();i++) {
			...
			//for(int j=0;j<thresholdList.length;j++) {
				if(distance>=Threshold) {
					...
					//}
					outlier++;
				//	result.OutlierList.add(this.getDataPoints().get(i).value(0));
				//}
			}
