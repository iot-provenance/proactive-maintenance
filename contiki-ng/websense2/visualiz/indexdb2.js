...
if(url.parse(req2.url,true).query!=null && url.parse(req2.url,true).query.node!=null){
  ...
  console.log(urladdress);
    request.get(urladdress,function(err,res,obj){
       ...
       // console.log(JSON.stringify(obj2.temp));
        if(obj2.act !== undefined){
            connection.query({
                sql: 'INSERT INTO iot.actions2(node_id,type, value,time) values(?,?,?,now())',
                timeout: 40000, // 40s
   ...
   if(obj2.t !== undefined){
        connection.query({
            sql: 'INSERT INTO iot.values2(node_id,type, value,time) values(?,"temp",?,now())',
            timeout: 40000, // 40s
            values: [ node, obj2.t]
        }, function (error, results, fields) {
            if(error){
    ...
    if(obj2.b !== undefined){
        connection.query({
            sql: 'INSERT INTO iot.values2(node_id,type, value,time) values(?,"battery",?,now())',
            timeout: 40000, // 40s
            values: [ node, obj2.b]
        }, function (error, results, fields) {
            if(error){
    ...
    if(obj2.c !== undefined){
        connection.query({
            sql: 'INSERT INTO iot.values2(node_id,type, value,time) values(?,"cpu",?,now())',
            timeout: 40000, // 40s
            values: [ node, obj2.c]
        }, function (error, results, fields) {
            if(error){
    ...
    if(obj2.m !== undefined){
        connection.query({
            sql: 'INSERT INTO iot.values2(node_id,type, value,time) values(?,"memory",?,now())',
            timeout: 40000, // 40s
            values: [ node, obj2.m]
        }, function (error, results, fields) {
            if(error){
    ...
    if(obj2.g !== undefined){
        connection.query({
            sql: 'INSERT INTO iot.values2(node_id,type, value,time) values(?,"gas",?,now())',
            timeout: 40000, // 40s
            values: [ node, obj2.g]
        }, function (error, results, fields) {
            if(error){
    ...
    if(obj2.p !== undefined){
        connection.query({
            sql: 'INSERT INTO iot.values2(node_id,type, value,time) values(?,"pressure",?,now())',
            timeout: 40000, // 40s
            values: [ node, obj2.p]
        }, function (error, results, fields) {
            if(error){
